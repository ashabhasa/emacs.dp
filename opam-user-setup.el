;; ## added by OPAM user-setup for emacs / base ## cfd3c9b7837c85cffd0c59de521990f0 ## you can edit, but keep this line  -*- lexical-binding: t; -*-
...
;; ## added by OPAM user-setup for emacs / tuareg ## 6e638415061e8cc8e64a580e0376eee0 ## you can edit, but keep this line
...
(defun opam-tuareg-autoload (fct file doc args)
  (let ((load-path (cons "/Users/arber/.opam/default/share/emacs/site-lisp" load-path)))
    (load file))
  (apply fct args))
...
;; ## added by OPAM user-setup for emacs / ocp-indent ## 68d788b4dc36c07d232fda6b0c54ccc8 ## you can edit, but keep this line
;; Load ocp-indent from its original switch when not found in current switch
(when (not (assoc "ocp-indent" opam-tools-installed))
  (autoload 'ocp-setup-indent "/Users/arber/.opam/default/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Tuareg mode")
  (autoload 'ocp-indent-caml-mode-setup "/Users/arber/.opam/default/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Caml mode")
  (add-hook 'tuareg-mode-hook 'ocp-setup-indent t)
  (add-hook 'caml-mode-hook 'ocp-indent-caml-mode-setup  t)
  (setq ocp-indent-path "/Users/arber/.opam/default/bin/ocp-indent"))
